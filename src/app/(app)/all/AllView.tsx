...
export function AllView({ initialTasks, userId }: Props) {
      ...
      <main className="pk-content">
        <div className="pk-content-inner">
          <div className="pk-view-head">
            <div>
              <h1 className="pk-view-title">Toutes les tâches</h1>
            </div>
          ...
          {tasks.length === 0 ? (
            <div className="pk-empty">
              <div className="pk-empty-title">Aucune tâche</div>
              <div className="pk-empty-sub">Commence par en créer une.</div>
            </div>
          ) : (
