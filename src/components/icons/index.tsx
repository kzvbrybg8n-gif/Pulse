...
export const IconFlame = (p: IconProps) => (
  <Svg {...p}>
    <path d="M8.5 14.5A2.5 2.5 0 0011 17c1.38 0 2.5-1.12 2.5-2.5 0-1.5-1-2.5-1.5-3.5-.5 1-1.5 1.5-2.5 1.5C9 12.5 8.5 13.5 8.5 14.5z" />
    <path d="M14 17a5 5 0 002-4c0-2-1-4-1-4 0 1.5-1 2-2 2 0-1.5-1-3.5-3-5 0 2.5-2 3.5-3 5.5a6 6 0 00-.5 2.5A5 5 0 0010 18" />
  </Svg>
);
